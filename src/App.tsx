...
interface BakayiseAppContentProps {
  onBackToAssistantHub?: () => void;
}

function BakayiseAppContent({ onBackToAssistantHub }: BakayiseAppContentProps) {
    ...
    <IPhoneMockupFrame isFrameActive={isIPhoneFrameMode}>
      <div className="min-h-screen bg-black text-white flex flex-col selection:bg-[#30D158]/30">
        ...
        <Navbar
          ...
          onBackToAssistantHub={onBackToAssistantHub}
        />
...
function AssistantAppRouter() {
  ...
  const [activeAppId, setActiveAppId] = useState<string | null>(getInitialApp);
